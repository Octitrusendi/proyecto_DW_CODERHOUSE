...
$message = "<html>
    ...
    <h2 style='margin-left: 20px; color:#425e3f;'>Solicitud de Consulta</h2>
    </div>  
    ...
    <tr>  
        <td style='padding: 5px; text-align: center;'><strong>Consulta</strong></td>
        <td style='padding: 5px; text-align: center;'><strong>" . $consulta ."</strong></td>    
    </tr>
...
try {
    ...
    //Content
    $mail->isHTML(true);   
    $mail->Subject = 'Solicitud de Consulta';
    $mail->Body    = $message;

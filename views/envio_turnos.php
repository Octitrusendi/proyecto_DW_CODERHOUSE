...
$message = "<html>
    ...
    <tr>  
        <td style='padding: 5px; text-align: center;'><strong>Sede elegida</strong></td>
    ...
    <tr>  
        <td style='padding: 5px; text-align: center;'><strong>Solicito un turno el día</strong></td>
...
try {
    ...
    $mail->Password   = '32778535Labo';                               //SMTP password
    ...
    //Content
    $mail->isHTML(true);   
    $mail->Subject = 'Solicitud de Turno';
    $mail->Body    = $message;
